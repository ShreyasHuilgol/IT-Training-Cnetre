...
namespace FinalCaseStudy.Controllers
{
    public class CourseDetailsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "courseid,course,duration,noofstd,cost")] CourseDetail courseDetail)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "courseid,course,duration,noofstd,cost")] CourseDetail courseDetail)
        {
            if (ModelState.IsValid)
            {
