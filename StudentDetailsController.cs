...
namespace FinalCaseStudy.Controllers
{
    public class StudentDetailsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Studentname,rollno,gender,age,course,address")] StudentDetail studentDetail)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Studentname,rollno,gender,age,course,address")] StudentDetail studentDetail)
        {
            if (ModelState.IsValid)
            {
